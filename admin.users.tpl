<!-- BEGIN: MAIN -->
		<div class="button-toolbar">
			<a title="{PHP.L.Configuration}" href="{ADMIN_USERS_URL}" class="button large">{PHP.L.Configuration}</a>
			<a href="{ADMIN_USERS_EXTRAFIELDS_URL}" class="button large">{PHP.L.adm_extrafields_desc}</a>
		</div>
