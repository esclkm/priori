...
{HEADER_HEAD}
		...
		<link href="{PHP.cfg.themes_dir}/admin/priori/css/reset.css" type="text/css" rel="stylesheet" />
		<link href="{PHP.cfg.themes_dir}/admin/priori/css/framework.css" type="text/css" rel="stylesheet" />
		<link href="{PHP.cfg.themes_dir}/admin/priori/css/buttons.css" type="text/css" rel="stylesheet" />
		<link href="{PHP.cfg.themes_dir}/admin/priori/css/admin.css" type="text/css" rel="stylesheet" />
		<link href="{PHP.cfg.themes_dir}/admin/priori/css/adaptive.css" type="text/css" rel="stylesheet" />
{HEADER_COMPOPUP}
